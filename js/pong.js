...
class Pong {
    constructor(canvas) {
        ...
        // Centering player vertically
        this.players.forEach(player => player.pos.y = this._canvas.height / 2);

        let lastTime;

        // Using arrow funciton here cause we need 'this' inside to refer to Class
    ...
    draw() {
        ...
        this._context.fillRect(this.stage.pos.x, this.stage.pos.y, this.stage.size.x, this.stage.size.y);
